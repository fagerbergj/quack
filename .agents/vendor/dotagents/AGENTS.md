...
I hate long comments. Keep them short — a line or two at most. Comment the non-obvious *why*, never restate what the code does. If a comment is longer than the code it explains, cut it. No narration, no change history, no ceremony.

# Writing style

Apply this ruleset to prose you write for me — chat replies, PR/issue text, docs, commit messages. Adapted from [Anbeeld/WRITING.md](https://github.com/Anbeeld/WRITING.md) (compact variant).
