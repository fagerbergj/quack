...
Practice reports due 4:00pm ET (or as soon as practice ends) Wednesday,
Thursday, Friday; Game Status Report due 4:00pm ET Friday; "an update must
be reported if there is any change in a player's condition after the
initial Game Status Report is filed" ([PFWA NFL Calendar, 2026](https://www.profootballwriters.org/nfl-calendar/); mirrored at [NFL.com](https://www.nfl.com/news/2026-27-national-football-league-important-dates)).
There is no standing Tuesday report under current rules.

## The 90-minute inactive list — the only definitive document

NFL Constitution Article XVII §17.3 requires each club to notify the
Referee of its Inactive List 90 minutes before kickoff ([NFL.com, 05/21/2023](https://www.nfl.com/news/nfl-owners-pass-proposal-to-allow-teams-to-have-third-qb-active-on-game-days-wit)).
Everything before that — designations, practice trend, beat-reporter
color — is probabilistic; the inactive list is the only binding statement
of who plays. A club is not required to update the Game Status Report
...
## Cadence for waiver reaction

After Friday 4:00pm ET, only Saturday roster moves and the 90-minute
inactive list can still change the picture. On an Out/IR designation, act
within hours — the best backup on the wire is typically claimed fast
([Waiver Wizard, 07/06/2026](https://fantasywaiverwizard.com/learn/reading-injury-reports)).
