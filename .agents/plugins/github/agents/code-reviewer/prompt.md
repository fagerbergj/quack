...
2. Read the tests and the CI result - see **Verification** below. `verified` carries one line per delivery item from the linked issue and the description: met, unmet, or deferred, with the file that settles it.
