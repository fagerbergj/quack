...
func appendNode(t *testing.T, s ledger.LedgerStore, chatID, nodeID, turn, kind string) {
	t.Helper()
	...
	if _, err := s.AppendIntent(context.Background(), ledger.Entry{ChatID: chatID, Kind: kind, Payload: payload}); err != nil {
