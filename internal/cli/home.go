...
// compose). Honors $QUACK_HOME, else ~/.quack - the ~/.kube / ~/.docker model (one self-contained dir, easy to find, back up, or rm -rf). Project config (quack.yaml) is separate - it stays in the project directory.
func Home() string {
