...
func TestRunDAG_Layers(t *testing.T) {
	...
	for _, n := range plan.Nodes {
		...
		gateNodes[n.ID] = newGatedNode(plan, n, wn, nil, nil, nil, vetting.NewJudgeFactory(stub, nil, nil), cfg("w"), nil, nil, "", nil, nil, nil, AdmissionSpec{}, nil, nil, continuation{}, nil)
	}
