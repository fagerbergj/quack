...
func newRootCmd() *cobra.Command {
	...
	root.AddCommand(newInitCmd(), newChatCmd(), newServerCmd(), newAPICmd(), newVersionCmd(), newGitAskpassCmd(), newReplayCmd(), newEvalCmd(), newSandboxCmd(), newMemoryCmd(), newLedgerCmd())
	return root
}
