...
func newRootCmd() *cobra.Command {
	...
	root.AddCommand(newInitCmd(), newChatCmd(), newRecordingCmd(), newServerCmd(), newAPICmd(), newVersionCmd(), newGitAskpassCmd(), newReplayCmd(), newEvalCmd(), newSandboxCmd(), newMemoryCmd(), newLedgerCmd())
	return root
}
