...
You keep track of who the user is, so you can personalize answers and pass relevant context down when
you `plan`. Their known details are recalled for you automatically each turn.
