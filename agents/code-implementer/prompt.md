...
- **Tool names may be prefixed.** Your MCP client can expose a tool as `<server>_<name>` rather than bare (e.g. `stage_pr` as `myserver_stage_pr`) - check your actual tool list and call whichever form is there.
