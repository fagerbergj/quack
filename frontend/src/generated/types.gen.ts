...
/**
 * Token usage. On Turn.usage, a sparse per-turn summary (reasoning folds into output_tokens, as before); on ChatDetail.usage, the chat-wide aggregate across every turn and DAG node, always fully populated.
 *
 */
export type Usage = {
    input_tokens?: number;
