...
// up from here and also handles OS-change/in-app switching .
  useEffect(() => {
    applyTheme()
  }, [])
...
// keyboard, which shrinks visualViewport without shrinking dvh .
// The inline height (from visualViewport) overrides h-dvh once it fires.
 ...
 {/* Nav drawer : Chats/Memory/extensions as a peer list, outside
