    ...
    <div ref={ref} className="relative flex-shrink-0">
      ...
      {open && (
        <Sheet anchored aria-label="Sort and filter memories" onClose={() => setOpen(false)} className="medium:absolute medium:right-0 medium:mt-1 medium:w-56 medium:rounded-lg medium:border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-2 medium:pb-2 text-sm medium:text-xs">
          <div className="px-1 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Sort</div>
          ...
          <label className="block px-1 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">
            Bucket
          </label>
          <select
            value={bucket}
          ...
          <label className="block px-1 py-0.5 mt-2 text-[10px] font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">
            Tier
          </label>
          <select
            value={tier}
