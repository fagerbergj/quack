...
export default function Sidebar({ open, onClose }: { open: boolean; onClose: () => void }) {
  return (
    <div className="fixed inset-y-0 left-0 z-30 w-64 flex-shrink-0 bg-gray-800 text-gray-100 transition-transform duration-200 md:relative md:translate-x-0" style={{ transform: open ? 'translateX(0)' : 'translateX(-100%)' }}>
